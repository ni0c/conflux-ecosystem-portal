import { q as T, r as w, x as c, a7 as J, a8 as l, a9 as N, aa as x, A as S, O as j, M as I, D as O, _ as Z, F as G, W as H, R as U, z as K, v as M, a1 as Q, K as ee, G as L, T as te } from "./umd-DIrkvCx7.mjs";
import { n as d, c as g, o as h, r as u } from "./if-defined-BeJkmk4s.mjs";
import { D as ie, T as re } from "./index-DGKwePaJ.mjs";
import "./index-0c9S7IvY.mjs";
import "./index-DBdqi8i8.mjs";
import "./index-CX-rios-.mjs";
import "./index-D7tlm4WM.mjs";
import { O as z } from "./index-BAkVN8hP.mjs";
...
let A = class extends w {
  constructor() {
    super(), this.unsubscribe = [], this.selectedOnRampProvider = l.state.selectedProvider, this.loading = !1, this.coinbaseTransactions = N.state.coinbaseTransactions, this.tokenImages = x.state.tokenImages, this.unsubscribe.push(l.subscribeKey("selectedProvider", (e) => {
    ...
    })), N.clearCursor(), this.fetchTransactions();
  }
  render() {
    return c`
  ...
  templateTransactions(e) {
    return e == null ? void 0 : e.map((t) => {
      ...
      if (!i)
        return null;
      const s = ((D = i == null ? void 0 : i.icon) == null ? void 0 : D.url) || ((F = this.tokenImages) == null ? void 0 : F[i.symbol || ""]);
      return c`
  ...
  templateTransactionsByYear() {
    return Object.keys(this.coinbaseTransactions).sort().reverse().map((t) => {
      ...
      return new Array(12).fill(null).map((i, s) => s).reverse().map((i) => {
        var D;
        const s = re.getTransactionGroupTitle(r, i), n = (D = this.coinbaseTransactions[r]) == null ? void 0 : D[i];
        return n ? c`
  ...
  async fetchCoinbaseTransactions() {
    ...
    this.loading = !0, await N.fetchTransactions(e, "coinbase"), this.loading = !1, this.refetchLoadingTransactions();
  }
  refetchLoadingTransactions() {
    ...
    this.refetchTimeout = setTimeout(async () => {
      ...
      await N.fetchTransactions(i, "coinbase"), this.refetchLoadingTransactions();
    }, 3e3);
  }
  templateLoading() {
...
let Y = class extends w {
  ...
  onClickProvider(e) {
    ...
    l.setSelectedProvider(e), U.push("BuyInProgress"), K.openHref(e.url, "popupWindow", "width=600,height=800,scrollbars=yes"), G.sendEvent({
      type: "track",
  ...
  async getCoinbaseOnRampURL() {
    ...
    return await Q.generateOnRampURL({
      defaultNetwork: r,
      destinationWallets: [
...
let m = class extends w {
  ...
  onTryAgain() {
    this.selectedOnRampProvider && (this.error = !1, K.openHref(this.selectedOnRampProvider.url, "popupWindow", "width=600,height=800,scrollbars=yes"));
  }
  tryAgainTemplate() {
    var e;
  ...
  onCopyUri() {
    ...
    try {
      K.copyToClopboard(this.selectedOnRampProvider.url), L.showSuccess("Link copied");
    } catch {
