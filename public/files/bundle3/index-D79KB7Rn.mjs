import { O as Y, ab as _, z as R, D as h, y as U, K as f, ac as $, a0 as W, F as N, G as I, A as E, R as O, ad as S, M as P, a5 as B, a6 as H, q as M, r as G, x as d, T as F } from "./umd-DIrkvCx7.mjs";
import { o as C, r as w, c as V } from "./if-defined-BeJkmk4s.mjs";
import "./index-B7Ho5unP.mjs";
import "./index-Bmy5DU92.mjs";
...
const D = 0, v = "unknown", n = W({
  ...
  async handleOpenPay(t) {
    this.resetState(), this.setPaymentConfig(t), this.subscribeEvents(), this.initializeAnalytics(), n.isConfigured = !0, N.sendEvent({
      type: "track",
...
x([
  w()
], A.prototype, "loadingMessage", void 0);
x([
  w()
], A.prototype, "subMessage", void 0);
x([
  w()
], A.prototype, "paymentState", void 0);
A = x([
