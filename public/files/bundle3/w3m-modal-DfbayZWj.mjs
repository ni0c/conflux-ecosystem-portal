import { M as w, ak as Z, R as c, q as v, w as U, r as y, x as l, Q as P, H as se, ah as re, D as p, _ as j, aa as ce, U as L, F as G, O as $, C as K, A as q, G as A, a7 as R, T as le, an as de, z as ue, y as pe } from "./umd-DIrkvCx7.mjs";
import { c as f, n as u, r as d, o as z, U as he } from "./if-defined-BeJkmk4s.mjs";
...
function H() {
  var n, r, W, x, T, E, O;
  const s = (r = (n = c.state.data) == null ? void 0 : n.connector) == null ? void 0 : r.name, e = (x = (W = c.state.data) == null ? void 0 : W.wallet) == null ? void 0 : x.name, t = (E = (T = c.state.data) == null ? void 0 : T.network) == null ? void 0 : E.name, i = e ?? s, a = K.getConnectors();
  return {
...
let h = class extends y {
  constructor() {
    super(), this.unsubscribe = [], this.heading = H()[c.state.view], this.network = p.state.activeCaipNetwork, this.networkImage = j.getNetworkImage(this.network), this.showBack = !1, this.prevHistoryLength = 1, this.view = c.state.view, this.viewDirection = "", this.headerText = H()[c.state.view], this.unsubscribe.push(ce.subscribeNetworkImages(() => {
      this.networkImage = j.getNetworkImage(this.network);
    }), c.subscribeKey("view", (e) => {
      setTimeout(() => {
        this.view = e, this.headerText = H()[e];
      }, L.ANIMATION_DURATIONS.HeaderText), this.onViewChange(), this.onHistoryChange();
  ...
  leftHeaderTemplate() {
    var x;
    const { view: e } = c.state, t = e === "Connect", i = $.state.enableEmbedded, a = e === "ApproveTransaction", o = e === "ConnectingSiwe", n = e === "Account", r = $.state.enableNetworkSwitch, W = a || o || t && i;
  ...
  onViewChange() {
    ...
    e.length < this.prevHistoryLength && (t = L.VIEW_DIRECTION.Prev), this.prevHistoryLength = e.length, this.viewDirection = t;
  }
...
class b extends y {
  constructor() {
    super(), this.unsubscribe = [], this.abortController = void 0, this.hasPrefetched = !1, this.enableEmbedded = $.state.enableEmbedded, this.open = w.state.open, this.caipAddress = p.state.activeCaipAddress, this.caipNetwork = p.state.activeCaipNetwork, this.shake = w.state.shake, this.filterByNamespace = K.state.filterByNamespace, this.initializeTheming(), R.prefetchAnalyticsConfig(), this.unsubscribe.push(w.subscribeKey("open", (e) => e ? this.onOpen() : this.onClose()), w.subscribeKey("shake", (e) => this.shake = e), p.subscribeKey("activeCaipNetwork", (e) => this.onNewNetwork(e)), p.subscribeKey("activeCaipAddress", (e) => this.onNewAddress(e)), $.subscribeKey("enableEmbedded", (e) => this.enableEmbedded = e), K.subscribeKey("filterByNamespace", (e) => {
      var t;
  ...
  onNewNetwork(e) {
    ...
    let I = !1;
    ne && !E && (O ? r && (I = !0) : (ae || x && !T) && (I = !0)), I && c.state.view !== "SIWXSignMessage" && c.goBack(), this.caipNetwork = e;
  }
  prefetch() {
