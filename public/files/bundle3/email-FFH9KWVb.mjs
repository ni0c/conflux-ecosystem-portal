import { q as E, w as L, H as U, r as w, x as u, J as _, R as l, C as h, z as x, G as v, F as c, D as S, K as k, O as F, M as z, N as M, y as B } from "./umd-DIrkvCx7.mjs";
import { n as I, c as d, r as m, U as D } from "./if-defined-BeJkmk4s.mjs";
import "./index-C7w-WRzd.mjs";
import "./index-CX-rios-.mjs";
import "./index-0c9S7IvY.mjs";
import { e as H, n as q } from "./ref-D5OJINrI.mjs";
  ...
  handlePaste(e, t, n) {
    ...
    if (o && D.isNumber(o)) {
      ...
      if (n + 1 < this.length && r.length) {
        const s = this.numerics[n + 1], A = s ? this.getInputElement(s) : void 0;
