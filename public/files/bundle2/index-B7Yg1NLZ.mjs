import { A as d, D as w, F as _, R as p, C as v, G as y, z as c, V as E, y as $, q as m, w as b, r as x, x as h, H as R } from "./umd-Cchevry1.mjs";
import { n as u, c as C, o as O } from "./if-defined-CSBB_pWG.mjs";
function T() {
  try {
...
async function j(t) {
  ...
  try {
    ...
    if (o && t) {
      if (c.isTelegram() || (e = T()), e)
        d.setSocialWindow(e, w.state.activeChain);
    ...
    e == null || e.close(), y.showError(i == null ? void 0 : i.message);
  }
}
async function F(t) {
  d.setSocialProvider(t, w.state.activeChain), _.sendEvent({
    type: "track",
    event: "SOCIAL_LOGIN_STARTED",
    properties: { provider: t }
  }), t === "farcaster" ? await U() : await j(t);
}
const L = m`
  :host {
    display: flex;
