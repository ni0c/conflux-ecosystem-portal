import { s as le } from "./sha2-DJsG9jSA.mjs";
import { ar as de, as as he, at as we, au as ge, av as kt, aw as me, ax as pe, ay as ye, az as be } from "./umd-Cchevry1.mjs";
class Wt extends de {
  constructor(n, t) {
...
const Dt = (e, n, t) => new Wt(e, n).update(t).digest();
Dt.create = (e, n) => new Wt(e, n);
...
function Ft(e) {
  return Zt(e), Gt(ut(Uint8Array.from(e).reverse()));
}
function dt(e, n) {
...
function ne(e, n) {
  const t = (e.ORDER + C) / Jt, r = e.pow(n, t);
  if (!e.eql(e.sqr(r), n))
    throw new Error("Cannot find square root");
  return r;
}
function Ae(e, n) {
  const t = (e.ORDER - te) / ee, r = e.mul(n, tt), i = e.pow(r, t), s = e.mul(n, i), c = e.mul(e.mul(s, tt), i), u = e.mul(s, e.sub(c, e.ONE));
  if (!e.eql(e.sqr(u), n))
    throw new Error("Cannot find square root");
  return u;
}
...
function Ne(e) {
  return e % Jt === Se ? ne : e % ee === te ? Ae : Ie(e);
}
const Oe = [
  "create",
  "isValid",
...
function Le(e, n, t = !1) {
  ...
  const c = t ? Ft(e) : et(e), u = M(c, n - C) + C;
  return t ? Qt(u, i) : dt(u, i);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
...
function Me(e) {
  ...
  class Z {
    ...
    recoverPublicKey(a) {
      ...
      const _ = E & 1 ? "03" : "02", W = m.fromHex(_ + It(L, t.BYTES)), P = d(L), V = o(-v * P), nt = o(S * P), F = m.BASE.multiplyAndAddUnsafe(W, V, nt);
      if (!F)
  ...
  function T(l, a, w, S = I) {
    ...
    const W = typeof E == "string" || lt(E), P = !W && !_ && typeof E == "object" && E !== null && typeof E.r == "bigint" && typeof E.s == "bigint";
    if (!W && !P)
...
const Rt = Tt(ue, void 0, void 0, { sqrt: $e }), Ge = je({
  a: Ke,
  b: BigInt(7),
  Fp: Rt,
  n: Pt,
