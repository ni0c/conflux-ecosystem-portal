import { q as d, w as f, r as p, x as g } from "./umd-Cchevry1.mjs";
import { n as c, c as u } from "./if-defined-CSBB_pWG.mjs";
const x = d`
  :host {
    display: flex;
  }
...
var l = function(o, t, s, r) {
  ...
  else for (var h = o.length - 1; h >= 0; h--) (n = o[h]) && (e = (a < 3 ? n(e) : a > 3 ? n(t, s, e) : n(t, s)) || e);
